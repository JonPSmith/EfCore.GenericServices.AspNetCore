...
namespace GenericServices.AspNetCore
{
    ...
    public static class ValidationHelper
    {
        ...
        public static void CopyErrorsToModelState<T>(this GenericServices.IStatusGeneric status, ModelStateDictionary modelState, T displayDto, string modelName = null)
        {
        ...
        public static void CopyErrorsToModelState(this GenericServices.IStatusGeneric status, ModelStateDictionary modelState)
        {
            if (status.IsValid) return;
